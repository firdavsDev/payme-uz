...
- `docs/KALITLAR.uz.md` is the Uzbek guide to obtaining credentials (cabinet paths, support request template, error table). Keep it in sync when the flow changes.
